package team009.lecture4;

import java.util.ArrayList;

import team009.lecture4.RobotPlayer;
...
public class BasicPathing{
    ...
    public static Direction getMoveDirection(Direction chosenDirection,boolean selfAvoiding,RobotController rc, int[] directionalLooks, Direction[] allDirections) throws GameActionException{
        while(snailTrail.size()<2)
            snailTrail.add(new MapLocation(-1,-1));
        if(rc.isActive()){
            snailTrail.remove(0);
